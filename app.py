...
from langchain.text_splitter import RecursiveCharacterTextSplitter  # Thay đổi loại text splitter
...
# Thay đổi từ OpenAI sang Google AI API key
...
def file_processing(file_path):
    ...
    # Sử dụng RecursiveCharacterTextSplitter thay vì TokenTextSplitter
...
def llm_pipeline(file_path):
    ...
    Create 15 questions that will prepare the coders or programmers for their tests.
